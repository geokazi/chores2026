...
const CHORES: PresetChore[] = [
  ...
  { key: 'make_bed', name: 'Make bed', points: 0, minutes: 3, category: 'weekday', icon: '🛏️' },
  { key: 'load_dishwasher', name: 'Load dishwasher', points: 1, minutes: 5, category: 'weekday', icon: '🍽️' },
  { key: 'quick_tidy', name: 'Quick tidy', points: 0, minutes: 5, category: 'weekday', icon: '✨' },
  { key: 'take_trash', name: 'Take out trash', points: 1, minutes: 5, category: 'weekday', icon: '🗑️' },
  // Weekend deep cleaning
  { key: 'vacuum_whole', name: 'Vacuum whole floor', points: 2, minutes: 25, category: 'weekend', icon: '🧹' },
  { key: 'mop_floors', name: 'Mop all floors', points: 2, minutes: 25, category: 'weekend', icon: '🧽' },
  { key: 'clean_bathroom', name: 'Deep clean bathroom', points: 3, minutes: 30, category: 'weekend', icon: '🚿' },
  { key: 'organize_closet', name: 'Organize closet', points: 2, minutes: 20, category: 'weekend', icon: '👕' },
  { key: 'wash_windows', name: 'Wash windows', points: 2, minutes: 20, category: 'weekend', icon: '🪟' },
  { key: 'yard_work', name: 'Yard work', points: 3, minutes: 30, category: 'weekend', icon: '🌿' },
];
