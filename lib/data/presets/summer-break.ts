...
const CHORES: PresetChore[] = [
  ...
  { key: 'breakfast_dishes', name: 'Breakfast dishes', points: 2, minutes: 10, category: 'morning', icon: '🍽️' },
  // Outdoor chores (summer focus)
  { key: 'water_garden', name: 'Water garden', points: 2, minutes: 15, category: 'outdoor', icon: '🌻' },
  { key: 'mow_lawn', name: 'Help mow lawn', points: 4, minutes: 30, category: 'outdoor', icon: '🌿' },
  { key: 'wash_car', name: 'Wash car', points: 3, minutes: 20, category: 'outdoor', icon: '🚗' },
  { key: 'pull_weeds', name: 'Pull weeds', points: 3, minutes: 20, category: 'outdoor', icon: '🌱' },
  { key: 'sweep_patio', name: 'Sweep patio', points: 2, minutes: 10, category: 'outdoor', icon: '🧹' },
  // Indoor chores
  ...
  { key: 'clean_room', name: 'Clean room', points: 3, minutes: 20, category: 'indoor', icon: '🏠' },
  // Evening routine
  { key: 'dinner_help', name: 'Help with dinner', points: 2, minutes: 15, category: 'evening', icon: '🍳' },
