...
- [Points Consistency: Single Source of Truth](./troubleshooting/20260131_points_consistency_single_source_of_truth.md) - Critical guide for timezone handling and ensuring all pages show consistent point totals
